...
public class Calculador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pantalla.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 255), 2, true));
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
       ...
       switch(this.operador){
           case"+":this.pantalla.setText(nocero(this.num1+this.num2));
           break;
           case"-":this.pantalla.setText(nocero(this.num1-this.num2));
           break;
           case"*":this.pantalla.setText(nocero(this.num1*this.num2));
           break;
           case"/":if(this.num2==0){this.pantalla.setText("ERROR.no se divide entre 0");}
           else{this.pantalla.setText(nocero(this.num1/this.num2));
           break;}
